...
public class ReporteTest {
	...
	static public void createPDF() throws Exception {
		...
		// JasperCompileManager.compileReport("/Users/javier/Proyectos/Workana/XmlToCFDI/xmltocfdi/src/main/resources/cfdi_v3_3.jrxml");
		...
		// String jasperSubPath =
		// "/Users/javier/Proyectos/Workana/XmlToCFDI/xmltocfdi/src/main/resources/Blank_A4.jasper";

		String imagesPath = "/Users/javier/Proyectos/Workana/XmlToCFDI/xmltocfdi/src/main/resources/";

		// Prefiero usar el .jrxml a la aplicacion que el .jasper por que es mas facil
		// de versionar
		...
		// Este parametro sirve para meter una funcion que el reporte va a ejecutar para
		// encontrar la ruta fisica de sus imagenes
		/*
		 * parameters.put("REPORT_FILE_RESOLVER", new FileResolver() { public File
		 * resolveFile(String fileName) { return new
		 * File(getServletContext().getRealPath("") + "\\mis_imagenes\\"+fileName); }
		 * });
		 */
		...
		params.put("observaciones",
				"Standard Export Packing (USA) Tesoro Number 5 Materials (Bottle, Label, Cap, & Case)");
		...
		// Sellos
		params.put("selloDigital",
				"ALmszy4C/MT/iIjE90FWvysKJH2wDd9fmiYpsXi4X96cn1vGkgsZwWt1TZ688UdAtj/DUSI6EsEBYnvJsRyqCfGR98l0i90eZeCpww1lHn27ZrBHQd2a20z3U6jrJknLGj3FHG6l4SPTeYD56EdGDxBm1jQn7YeNSoOi62\n"
						...
						+ "vo5QEz3QJbly6Aw==");
		params.put("selloSAT",
				"PEerMD/N7C8ue79PIgd3oT4HhguTRNEL8AmrUy/tyBnFZRpQtoKtveDClfeEcP1G90URd/HzCA///Vi+CjIjHvYxPccx0dPX4s0GwcSLtAngYLsK5zVdJIXRYS9CcYGny0QT/pOHilUq/W+Xh8awzOXiPI0739/VyzA/wVh\n"
		...
		params.put("SUB_REPORT",
				"/Users/javier/Proyectos/Workana/XmlToCFDI/xmltocfdi/src/main/resources/cfdi_v3_3_sub.jasper");
		 ...
		 * 
		 * JasperPrint jasperPrint = JasperFillManager.fillReport(mainreport,params,new
		 * JRBeanCollectionDataSource(productos));
		 */
		...
		/*
		 * ByteArrayOutputStream baos = new ByteArrayOutputStream(); JRPdfExporter
		 * exporter = new JRPdfExporter(); //Add the list as a Parameter
		 * exporter.setParameter(JRExporterParameter.JASPER_PRINT_LIST,
		 * jasperPrintList); //this will make a bookmark in the exported PDF for each of
		 * the reports //exporter.setParameter(JRPdfExporterParameter.
		 * IS_CREATING_BATCH_MODE_BOOKMARKS, Boolean.TRUE);
		 * exporter.setParameter(JRExporterParameter.OUTPUT_STREAM, baos);
		 * exporter.exportReport(); byte[] pdfBytes = baos.toByteArray();
		 */
